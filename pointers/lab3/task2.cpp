...
public:
  ...
  Book(const string &name, const string &author, const string &publisher,
       const int &ISBN, const int &edition) {
    this->name = name;
    this->author = author;
    this->publisher = publisher;
    this->ISBN = ISBN;
  ...
  void inputDetails() {
    ...
    cin >> name;
    cout << "Enter the author of a book: ";
    cin >> author;
    cout << "Enter the publisher of a book: ";
    cin >> publisher;
    cout << "Enter the assignedCMS of a book: ";
    cin >> assignedCMS;
    cout << "Enter the ISBN of a book: ";
    cin >> ISBN;
    cout << "Enter the edition of a book: ";
    cin >> edition;
    cout << "Enter the isAvailable (1: true and 0: false) of a book";
    cin >> isAvailable;
  }
  ...
  bool availabilityStatus() { return isAvailable; }
...
Library(const string& librarian, const int& maxBookNums){
  this->librarian = librarian;
  ...
  void searchBook(const string &bookName) {
    ...
    for (int i{0}; i < currBooksNum; i++) {
      if ((booksPtr + i)->get_book_name() == bookName){
        cout << "Availability status: " << (booksPtr + i)->availabilityStatus();
        isAvailable = true;
        break;
        }
    }
